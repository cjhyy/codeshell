 ...
 */
import type { PermissionMode as CorePermissionMode } from "../types.js";

/** Permission modes supported by the mobile remote wire protocol. */
export type MobileRemotePermissionMode = Extract<
  CorePermissionMode,
  "default" | "acceptEdits" | "bypassPermissions"
>;

type PermissionMode = MobileRemotePermissionMode;
...
export type MobileClientEvent =
  ...
  | {
      ...
      sessionId: string;
      sinceSeq?: number;
      /** Main lifetime paired with sinceSeq; omitted by legacy clients. */
      epoch?: string;
    }
  // ── Capability controls ──────────────────────────────────────────────────
...
export type MobileServerEvent =
  ...
  | {
      ...
      seq: number;
      event: unknown;
      /** Main lifetime in which seq is valid; omitted by legacy servers. */
      epoch?: string;
    }
  // ── Capability controls ──────────────────────────────────────────────────
