...
import {
  queryCapabilityModules,
  registerCapabilityModules,
...
export class Engine {
  ...
  constructor(private config: EngineConfig) {
    ...
    registerCapabilityModules(this.toolRegistry, config.capabilities ?? []);
  ...
  queryCapability(
    ...
    return queryCapabilityModules(this.config.capabilities ?? [], type, params);
  }
