  ...
  zh: {
    auto: {
      ...
      runs: {
        ...
        filterAll: "全部",
        refresh: "刷新",
        noMatch: "没有匹配的托管运行。自动化的历史在「自动化」页,每次执行是一段可回看的对话。",
        noObjective: "(未填写目标)",
  ...
  en: {
    auto: {
      ...
      runs: {
        ...
        refresh: "Refresh",
        noMatch:
          "No matching managed runs. Automation history lives on the Automation page — each firing is a reviewable conversation.",
