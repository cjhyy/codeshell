  ...
  en: {
    chat: {
      ...
      contextPackage: {
        ...
        title: "Select conversations to forward",
        hint: "Select one or a continuous range; forwarding creates a new session.",
        create: "Forward to new session",
        cancel: "Cancel",
