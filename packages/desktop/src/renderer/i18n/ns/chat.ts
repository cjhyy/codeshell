...
export const chat = {
  zh: {
    chat: {
      ...
      contextPackage: {
        select: "合并转发",
        title: "合并转发",
        hint: "按 user turn 选择；选择首尾后，中间回合会一起合并到新会话。",
        create: "合并转发",
        cancel: "取消",
        cancelAria: "退出合并转发",
        loading: "正在读取原始事件…",
        packaging: "正在生成新会话…",
        empty: "没有可选择的已完成回合。",
        selected: "已选 {count} 个 user turn",
        turnLabel: "User turn #{number}",
        turnAria: "选择 user turn {number}",
  ...
  en: {
    chat: {
      ...
      contextPackage: {
        select: "Merge & forward",
        title: "Merge & forward",
        hint: "Select by user turn; turns between the first and last selection are merged too.",
        create: "Merge & forward",
        cancel: "Cancel",
        cancelAria: "Exit merge and forward",
        loading: "Reading raw events…",
        packaging: "Creating new session…",
        empty: "No completed turns are available.",
        selected: "{count} user turns selected",
        turnLabel: "User turn #{number}",
        turnAria: "Select user turn {number}",
