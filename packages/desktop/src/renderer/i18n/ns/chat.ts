  ...
  zh: {
    chat: {
      ...
      composer: {
        ...
        addFile: "添加本地文件",
        addFileTitle: "添加图片或本地文件路径（也支持拖拽 / 粘贴图片）",
        addFileNoVisionTitle: "添加本地文件路径；当前模型不支持图片输入",
        dropFiles: "松开以添加图片或本地文件路径",
        localFilePaths: "本地文件路径（由你选择）",
        filePathUnavailable: "无法获取这些文件的本地路径：{names}。请重启应用后重试。",
      ...
      slash: {
        ...
        loopTitle: "独立长循环",
        loopDescription: "启动或管理不依赖 Goal 的持久循环",
        loopBusy: "请等当前轮次结束后再执行 /loop。",
  ...
  en: {
    chat: {
      ...
      composer: {
        ...
        addFileTitle: "Add an image or local file path (image paste and drop also work)",
        addFileNoVisionTitle:
          "Add a local file path; the current model does not support image input",
        dropFiles: "Drop to add images or local file paths",
        localFilePaths: "Local file paths (selected by you)",
        filePathUnavailable:
          "Could not get local paths for these files: {names}. Restart the app and try again.",
      ...
      slash: {
        ...
        loopTitle: "Standalone long loop",
        loopDescription: "Start or control a durable loop without Goal mode",
        loopBusy: "Wait for the current turn to finish before running /loop.",
