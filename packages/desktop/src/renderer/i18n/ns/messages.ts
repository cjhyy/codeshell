  ...
  zh: {
    msg: {
      ...
      ask: {
        ...
        questionUnavailable: "未收到问题内容，暂时无法回答。",
        submit: "提交",
        answer: "回答",
        timedOut: "未回答,已自动继续",
        cancelled: "问题已取消",
        asyncHint: "可以稍后回答，任务会继续。",
        later: "稍后回答",
        resume: "回答问题",
        sending: "正在提交…",
        submitFailed: "回答提交失败，请重试。",
      },
  ...
  en: {
    msg: {
      ...
      ask: {
        ...
        questionUnavailable: "The question text is missing, so it cannot be answered yet.",
        submit: "Submit",
        answer: "Answer",
        timedOut: "No answer — continued automatically",
        cancelled: "Question cancelled",
        asyncHint: "You can answer later. The task will continue.",
        later: "Answer later",
        resume: "Answer question",
        sending: "Sending…",
        submitFailed: "Your answer could not be sent. Please try again.",
      },
      turnUsage: {
        summary: "Turn usage",
        tokens: "{count} tokens",
