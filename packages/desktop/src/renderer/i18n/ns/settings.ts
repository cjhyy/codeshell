...
export const settingsNs = {
  zh: {
    settingsX: {
      ...
      view: {
        global: "全局",
        globalTitle: "所有项目的默认配置",
        currentProject: "当前项目",
        currentProjectTitle: "仅当前项目，覆盖全局默认",
        pickProjectFirst: "先在左侧选一个项目",
        pickAProject: "(选一个项目)",
        tabModel: "模型",
        tabCatalog: "模型目录",
        tabPermission: "权限",
      ...
      plugins: {
        ...
        refresh: "刷新",
        noMatch: "没有匹配的 skill",
        noSkillInPlugin: "该插件未提供 skill",
        selectPluginHint: "选择左侧任一插件查看其 skill",
        selectPluginHint2: "选择左侧任一插件以查看其 skill",
        skillGone: "该 skill 不存在或已被移除",
        copyName: "复制名称",
        copyNameTitle: "复制 skill 名称",
        reveal: "定位",
        ...
        infoDesc: "说明",
        infoLocalDesc: "来自 user / project 范围的本地 skill。可在中间栏单独启用或禁用。",
        infoCount: "数量",
        infoDescription: "描述",
        infoSource: "来源",
        infoVersion: "版本",
        versionUnknown: "(未知)",
        infoInstallPath: "安装位置",
        infoSkillCount: "Skill 数量",
        infoInstalledAt: "安装时间",
        installFromGithub: "从 GitHub 安装",
        installFromLocal: "从本地文件夹",
        pickLocalFolder: "选择本地文件夹",
        needsSkillMd: "需要包含 SKILL.md。",
        sourceFolder: "来源文件夹",
        pickSkillFolder: "选择一个 Skill 文件夹",
        installName: "安装名称",
        installLocation: "安装位置",
        scopeGlobal: "全局",
        scopeGlobalDesc: "对所有项目可用",
        scopeCurrentProject: "当前项目",
        noProjectSelected: "未选中项目",
        installing: "安装中...",
        installSkill: "安装 Skill",
        ghPlaceholder: "https://github.com/owner/repo",
        parsing: "解析中…",
        parse: "解析",
        ghHelp: "支持仓库 URL，或子目录形式",
        ghHelpSuffix: "。系统会读取仓库目录树，不会自动执行任何脚本。",
      ...
      mcp: {
        ...
        disableThis: "停用此服务器",
        enableThis: "启用此服务器",
        pluginManagedNoToggle: "由插件管理，不能在这里启停",
        ...
        edit: "编辑",
        delete: "删除",
        pluginManagedHint: "由「{owner}」插件提供;在插件页启停整个插件",
        pluginProvidedHint: "由插件提供",
        readOnly: "只读",
        readOnlyPluginManaged: "只读：由「{owner}」插件管理",
  ...
  en: {
    settingsX: {
      ...
      view: {
        global: "Global",
        globalTitle: "Default config for all projects",
        currentProject: "Current project",
        currentProjectTitle: "Only this project, overrides global defaults",
        pickProjectFirst: "Pick a project on the left first",
      ...
      capOverview: {
        ...
        scopeAria: "Capability config scope",
      ...
      plugins: {
        ...
        noSkillInPlugin: "This plugin provides no skills",
        selectPluginHint: "Select any plugin on the left to view its skills",
        selectPluginHint2: "Select any plugin on the left to view its skills",
        skillGone: "This skill does not exist or has been removed",
        copyName: "Copy name",
        copyNameTitle: "Copy skill name",
        reveal: "Reveal",
        ...
        infoInstallPath: "Install path",
        infoSkillCount: "Skill count",
        infoInstalledAt: "Installed at",
        installFromGithub: "Install from GitHub",
        installFromLocal: "From local folder",
        pickLocalFolder: "Pick a local folder",
        needsSkillMd: "Must contain SKILL.md.",
        sourceFolder: "Source folder",
        pickSkillFolder: "Pick a Skill folder",
        installName: "Install name",
        installLocation: "Install location",
        scopeGlobal: "Global",
        scopeGlobalDesc: "Available to all projects",
