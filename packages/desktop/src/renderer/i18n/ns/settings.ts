  ...
  en: {
    settingsX: {
      ...
      memory: {
        ...
        cleanupTitle: "Review auto-extracted memories in this scope; confirmed deletions move to memory-trash/ and are restorable",
        ...
        cleanupReviewDesc: "Only auto-extracted and unpinned entries are selected by default; canceling changes no files.",
        ...
        useCountTitle: "Times this memory was read (recalled) — frequently-recalled memories are never pruned by TTL",
