  ...
  zh: {
    misc: {
      updater: {
        ...
        manualRequiredSignature: "发现新版本 {version}。当前 macOS 安装包使用旧的 cdhash ad-hoc 签名,需要手动下载安装一次。",
        manualRequiredReadOnly: "发现新版本 {version}。当前 App 位于只读卷或隔离位置,请移到“应用程序”后重试,或手动下载安装。",
  ...
  en: {
    misc: {
      updater: {
        ...
        manualRequiredSignature: "Version {version} is available. This macOS install uses the old cdhash ad-hoc signature, so install this transition manually once.",
        manualRequiredReadOnly: "Version {version} is available. The app is on a read-only or translocated location; move it to Applications and retry, or install manually.",
