...
export function ConnectionGate({ status }: { status: ConnStatus }) {
  const copy: Record<Exclude<ConnStatus, "online">, { title: string; body: string; tone: string }> = {
  ...
  return (
    <div className="grid min-h-dvh place-items-center bg-background px-8 text-center">
      <div className="flex max-w-xs flex-col items-center gap-3">
        <div className="grid size-12 place-items-center rounded-xl bg-primary text-lg font-black text-primary-foreground">
          C
        </div>
